 ...
 * Simple UI for Google authentication
 */
    ...
    <Card className={`p-8 max-w-md mx-auto ${className}`}>
      <div className="text-center space-y-6">
        ...
        <div className="flex justify-center">
          <div className="w-16 h-16 bg-gradient-to-r from-teal-400 to-teal-600 rounded-lg flex items-center justify-center">
        ...
        {/* Title */}
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Welcome to TravelPlanner</h1>
